...
ClusterIcon.prototype.onAdd = function () {
    ...
    google.maps.event.addDomListener(this.div_, "click", function (e) {
        ...
        * @event
        */
        var allClusterMarkers = mc.getMarkers();
        for (var i = 0; i < allClusterMarkers.length; i++) {
            //Info window goes here!
            alert(allClusterMarkers[i].title);
...
* @property {boolean} [zoomOnClick=false] Whether to zoom the map when a cluster marker is
...
MarkerClusterer.prototype.getAllClusters = function () {
